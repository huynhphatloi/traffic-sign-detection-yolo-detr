...
Mức suy giảm trên vật thể nhỏ lớn gấp 1,9 lần mAP tổng ở phép chưng cất, và gấp 6,5 lần ở phép
...
Ngoài ra, luận điểm này được kiểm chứng độc lập trên dữ liệu ngoài phân bố: trên ba đoạn video
đường phố, việc tăng độ phân giải đầu vào làm số phát hiện ở nhóm vật thể nhỏ tăng 6,1 lần trong khi
nhóm vừa chỉ tăng 1,4 lần. Tính chọn lọc theo kích thước này là chữ ký của cơ chế đã nêu, chứ không
phải của nhiễu ngẫu nhiên.
...
luyện, tức 10,2\%. Mọi con số mAP tuyệt đối vì vậy nên được hiểu là cận trên. Các phép so sánh
tương đối ít bị ảnh hưởng hơn vì rò rỉ tác động như nhau tới cả năm cấu hình.
...
Không thể loại trừ hoàn toàn khả năng một phần phát hiện thêm là dương tính giả, dù độ tin cậy trung
bình không sụt và tính chọn lọc theo kích thước đều nghiêng về giả thuyết ngược lại. Ngoài ra phép
kiểm chứng này dùng trọng số YOLOv8n của ứng dụng trình diễn chứ không phải các mô hình YOLO26 ở
những mục khác, nên không so sánh trực tiếp được.

\textbf{Chưa đo trên tập kiểm tra sạch.} Báo cáo đã xác định được 573 ảnh không bị rò rỉ nhưng chưa
tính lại toàn bộ chỉ số riêng trên tập con này.

\section{Hướng phát triển}

Các hướng phát triển được sắp theo thứ tự ưu tiên, từ chi phí thấp tới chi phí cao.

\textbf{Ưu tiên 1 --- Đo lại trên tập kiểm tra sạch.} Tập 573 ảnh không rò rỉ đã được xác định; chỉ
cần chạy lại khâu đánh giá trên tập con này để có bộ số không bị thổi phồng. Chi phí gần như bằng
không vì không phải huấn luyện lại.
